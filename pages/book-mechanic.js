    ...
    <div>
      ...
      <div className=''>
        <div className="h-full md:flex">
          <div
            className="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-900 to-blue-600 i justify-around items-center hidden">
            <div>
          ...
          <div className="flex md:w-1/2 justify-center py-10 px-12 items-center bg-white">
