  ...
  return (
    <div>
      ...
      <div className='p-20 flex justify-evenly'>
        <h2 className='w-[600px] font-Muli text-3xl'>
        Call: +92 318 1144183
        </h2>
        <p>
      ...
      <div className='p-20'>
        ...
        <form className='w-full'>
          ...
          <div className='flex flex-col space-y-3'>
            <input className='border-[1px] border-gray-400 py-5 w-[500px] h-12' placeholder=' Your Name'/>
            <input className='border-[1px] border-gray-400 py-5 w-[500px] h-12' placeholder=' Your Subject'/>
            <input className='border-[1px] border-gray-400 py-5 w-[500px] h-12' placeholder=' E-mail'/>
          </div>

          <div className='flex-grow'>
            <textarea  className='resize-none w-[100%] h-[100%] mx-5 border-[1px] border-gray-400' placeholder=' Comments' />
          </div>
          </div>
